...
const beerShops = [
    ...
    },
    {
        ...
        lat: 59.23603158246603,
        lon: 17.982808312508464,
        hours: { 0: [12, 22], 1: [10, 22], 2: [10, 23], 3: [10, 23], 4: [10, 23], 5: [10, 1], 6: [11, 1] }
    },
    {
        name: "Casa Bianca",
        lat: 59.22277615064302,
        lon: 17.938919348755377,
        hours: { 0: [11, 22], 1: [9, 22], 2: [9, 22], 3: [9, 22], 4: [9, 22], 5: [9, 22], 6: [11, 22] }
    },    
    {
        name: "Märtas krog",
